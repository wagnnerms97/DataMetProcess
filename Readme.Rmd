...
The Shiny application can be accessed via DMPshiny(), and by default, a page will open in the browser. For additional configurations, refer to ***?DMPshiny()***.
...
The same applies to all the code related to the application, which can be found in `inst/DataMetProcess_Shiny`
